  ...
  return (
    <section className="bg-[#edf9fe] py-20">
      <div className="max-w-[1320px] px-5 w-full mx-auto md:px-10 lg:px-20 flex flex-col   xl:flex-row lg:flex-row    items-center gap-8 md:gap-16">
        <div className="flex flex-col  items-start xl:w-[55%] lg:w-[55%] w-full">
          <h5 className="text-xl gilroy-semibold md:text-2xl lg:text-[40px] font-normal lg:leading-[60px] text-blue-600 text-start mb-6 md:mb-10">
            Exploring Your Value with College Mastermind
          </h5>
          <p className=" mb-6 text-[22px] text-[#758EB3]">
