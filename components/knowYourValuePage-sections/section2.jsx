...
const Knowsecondsection = () => {
  return (
    <section className="bg-[#edf9fe] py-20">
      <h2 className="font-normal  gilroy-semibold  md:text-2xl lg:text-[40px] text-center xl:w-[75%] lg:w-[90%] w-full   mx-auto mb-20">
        Know Your Value
        </h2>
      <div className="max-w-[1320px] px-5 w-full mx-auto md:px-10 lg:px-20 flex flex-col md:flex-row items-center gap-8 md:gap-16">
        ...
        <div className="flex flex-col items-start">
          <h5 className="text-xl md:text-2xl lg:text-[40px] gilroy-semibold !leading-[48px] font-bold text-blue-600 text-start mb-6 md:mb-10">
            Knowing and articulating the value you offer a university is
            essential for gaining admission into your top choices. 
          </h5>
          <p className="text-black mb-6 text-[22px]">
